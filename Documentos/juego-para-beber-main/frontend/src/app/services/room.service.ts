  ...
  return {
    ...
    ranking: rankingRaw.map(item => {
      ...
      return {
        ...
        accuracy: Number(pick(r, 'accuracy', 'Accuracy') ?? 0),
        accuracyPercent: Number(pick(r, 'accuracyPercent', 'AccuracyPercent') ?? 0),
        relativePerformance: Number(pick(r, 'relativePerformance', 'RelativePerformance') ?? 0),
